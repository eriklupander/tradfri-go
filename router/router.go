...
func SetupChi(client *tradfri.Client, port int) {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Get("/deviceParam/{deviceId}", getDevice)
		r.Put("/deviceParam/{deviceId}/color", setColorXY)
		r.Put("/deviceParam/{deviceId}/rgb", setColorRGBHex)
		r.Put("/deviceParam/{deviceId}/dimmer", setDimming)
		r.Put("/deviceParam/{deviceId}/power", setPower)
		r.Put("/deviceParam/{deviceId}", setState)
		r.Put("/deviceParam/{deviceId}/position", setPositioning)
	})
